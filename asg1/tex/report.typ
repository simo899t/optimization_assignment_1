...
This way, whenever any a good path $x in RR^2 $ is found, the seach space trajectory is updated ```py self.trajectory = x```
...
=== Visualisation
#figure(
  image("assets/init_100s.png", width: 30em),
...
#figure(
  image("assets/problem.png", width: 30em),
