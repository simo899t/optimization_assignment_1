...
optimizers.append(optim.AdamW(models[1].parameters(), lr=0.01))
optimizers.append(optim.AdamW(models[2].parameters(), lr=0.02))
optimizers.append(optim.AdamW(models[3].parameters(), lr=0.025))
optimizers.append(optim.AdamW(models[4].parameters(), lr=0.03))
...
# Plot the first
ax[0].plot(train_losses[0, :, 0], train_losses[0, :, 1], label="Train Loss AdamW - lr=0.001", color="blue")
ax[0].plot(train_losses[1, :, 0], train_losses[1, :, 1], label="Train Loss AdamW - lr=0.01", color="red")
ax[0].plot(train_losses[2, :, 0], train_losses[2, :, 1], label="Train Loss AdamW - lr=0.02", color="green")
ax[0].plot(train_losses[3, :, 0], train_losses[3, :, 1], label="Train Loss AdamW - lr=0.025", color="yellow")
ax[0].plot(train_losses[4, :, 0], train_losses[4, :, 1], label="Train Loss AdamW - lr=0.03", color="cyan")
...
ax[1].plot(accuracy[0, :, 0], accuracy[0, :, 1], label="Accuracy AdamW - lr=0.001", color="blue")
ax[1].plot(accuracy[1, :, 0], accuracy[1, :, 1], label="Accuracy AdamW - lr=0.01", color="red")
ax[1].plot(accuracy[2, :, 0], accuracy[2, :, 1], label="Accuracy AdamW - lr=0.02", color="green")
ax[1].plot(accuracy[3, :, 0], accuracy[3, :, 1], label="Accuracy AdamW - lr=0.025", color="yellow")
ax[1].plot(accuracy[4, :, 0], accuracy[4, :, 1], label="Accuracy AdamW - lr=0.03", color="cyan")
...
ax[2].plot(test_losses[0, :, 0], test_losses[0, :, 1], label="Test Loss AdamW - lr=0.001", color="blue")
ax[2].plot(test_losses[1, :, 0], test_losses[1, :, 1], label="Test Loss AdamW - lr=0.01", color="red")
ax[2].plot(test_losses[2, :, 0], test_losses[2, :, 1], label="Test Loss AdamW - lr=0.02", color="green")
ax[2].plot(test_losses[3, :, 0], test_losses[3, :, 1], label="Test Loss AdamW - lr=0.025", color="yellow")
ax[2].plot(test_losses[4, :, 0], test_losses[4, :, 1], label="Test Loss AdamW - lr=0.03", color="cyan")
...
plt.tight_layout()
plt.savefig('Comparing_AdamW_LRs_30_epochs.png')
plt.show()
