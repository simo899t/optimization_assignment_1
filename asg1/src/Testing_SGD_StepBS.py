...
optimizers.append(optim.SGD(models[1].parameters(), lr=0.001, momentum= 0.95))
optimizers.append(optim.SGD(models[2].parameters(), lr=0.001, momentum= 0.95))


modelSTD = LeNet5().to(device)
optimizerSTD = optim.SGD(modelSTD.parameters(), lr=0.001, momentum = 0.95)
...
plt.tight_layout()
plt.savefig('Comparing_StepBS_SGD_StartBS=64.png')
plt.show()
