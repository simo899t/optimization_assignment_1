...
ax[0].plot(train_losses[0, :, 0], train_losses[0, :, 1], label="Train Loss - Fast AdamW", color="blue")
ax[0].plot(train_losses[1, :, 0], train_losses[1, :, 1], label="Train Loss - Base Model", color="red", linestyle="--")
...
# Plot Test Accuracy
ax[1].plot(accuracy[0, :, 0], accuracy[0, :, 1], label="Train Loss - Fast AdamW", color="blue")
ax[1].plot(accuracy[1, :, 0], accuracy[1, :, 1], label="Train Loss - Base Model", color="red", linestyle="--")
...
# Plot Test Loss
ax[2].plot(test_losses[0, :, 0], test_losses[0, :, 1], label="Train Loss - Fast AdamW", color="blue")
ax[2].plot(test_losses[1, :, 0], train_losses[1, :, 1], label="Train Loss - Base Model", color="red", linestyle="--")
