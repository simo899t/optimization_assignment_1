...
optimizers.append(optim.SGD(models[3].parameters(), lr=0.001, momentum = 0.95))
optimizers.append(optim.SGD(models[4].parameters(), lr=0.001, momentum = 0.95))
...
plt.tight_layout()
plt.savefig('Comparing_SA_for_SGD_64.png')
plt.show()
