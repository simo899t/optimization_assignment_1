...
optimizers = []
optimizers.append(optim.AdamW(models[0].parameters(), lr=0.001, weight_decay=0.0001))
optimizers.append(optim.AdamW(models[1].parameters(), lr=0.001, weight_decay=0.001))
optimizers.append(optim.AdamW(models[2].parameters(), lr=0.001, weight_decay=0.01))
optimizers.append(optim.AdamW(models[3].parameters(), lr=0.001, weight_decay=0.05))
optimizers.append(optim.AdamW(models[4].parameters(), lr=0.001, weight_decay=0.1))
...
# Plot Train Loss
ax[0].plot(train_losses[0, :, 0], train_losses[0, :, 1], label="Train Loss AdamW - wd=0.0001", color="blue")
ax[0].plot(train_losses[1, :, 0], train_losses[1, :, 1], label="Train Loss AdamW - wd=0.001", color="red")
ax[0].plot(train_losses[2, :, 0], train_losses[2, :, 1], label="Train Loss AdamW - wd=0.01", color="green")
ax[0].plot(train_losses[3, :, 0], train_losses[3, :, 1], label="Train Loss AdamW - wd=0.05", color="yellow")
ax[0].plot(train_losses[4, :, 0], train_losses[4, :, 1], label="Train Loss AdamW - wd=0.1", color="cyan")
ax[0].plot(train_losses[5, :, 0], train_losses[5, :, 1], label="Train Loss AdamW - wd=0", color="lime")
ax[0].legend(loc="upper right")
ax[0].grid(True)

# Plot Test Accuracy
ax[1].plot(accuracy[0, :, 0], accuracy[0, :, 1], label="Accuracy AdamW - wd=0.0001", color="blue")
ax[1].plot(accuracy[1, :, 0], accuracy[1, :, 1], label="Accuracy AdamW - wd=0.001", color="red")
ax[1].plot(accuracy[2, :, 0], accuracy[2, :, 1], label="Accuracy AdamW - wd=0.01", color="green")
ax[1].plot(accuracy[3, :, 0], accuracy[3, :, 1], label="Accuracy AdamW - wd=0.05", color="yellow")
ax[1].plot(accuracy[4, :, 0], accuracy[4, :, 1], label="Accuracy AdamW - wd=0.1", color="cyan")
ax[1].plot(accuracy[5, :, 0], accuracy[5, :, 1], label="Accuracy AdamW - wd=0", color="lime")
ax[1].set_ylabel("Test Accuracy")
ax[1].legend(loc="lower right")
ax[1].grid(True)

# Plot Test Loss
ax[2].plot(test_losses[0, :, 0], test_losses[0, :, 1], label="Test Loss AdamW - wd=0.0001", color="blue")
ax[2].plot(test_losses[1, :, 0], test_losses[1, :, 1], label="Test Loss AdamW - wd=0.001", color="red")
ax[2].plot(test_losses[2, :, 0], test_losses[2, :, 1], label="Test Loss AdamW - wd=0.01", color="green")
ax[2].plot(test_losses[3, :, 0], test_losses[3, :, 1], label="Test Loss AdamW - wd=0.05", color="yellow")
ax[2].plot(test_losses[4, :, 0], test_losses[4, :, 1], label="Test Loss AdamW - wd=0.1", color="cyan")
ax[2].plot(test_losses[5, :, 0], test_losses[5, :, 1], label="Test Loss AdamW - wd=0", color="lime")
...
plt.tight_layout()
plt.savefig('Comparing_Different_wd_for_adamW_lr=0.001.png')
plt.show()
