...
# Plot the first
ax[0].plot(train_losses[0, :, 0], train_losses[0, :, 1], label="Train Loss SGD - WarmEpochsFactor = 10", color="blue")
ax[0].plot(train_losses[1, :, 0], train_losses[1, :, 1], label="Train Loss SGD - WarmEpochsFactor = 20", color="red")
ax[0].plot(train_losses[2, :, 0], train_losses[2, :, 1], label="Train Loss SGD - WarmEpochsFactor = 30", color="green")
ax[0].plot(train_losses[3, :, 0], train_losses[3, :, 1], label="Train Loss SGD - WarmEpochsFactor = 40", color="yellow")
ax[0].plot(train_losses[4, :, 0], train_losses[4, :, 1], label="Train Loss SGD - WarmEpochsFactor = 50", color="cyan")
...
ax[1].plot(accuracy[0, :, 0], accuracy[0, :, 1], label="Accuracy SGD - WarmEpochsFactor = 10", color="blue")
ax[1].plot(accuracy[1, :, 0], accuracy[1, :, 1], label="Accuracy SGD - WarmEpochsFactor = 20", color="red")
ax[1].plot(accuracy[2, :, 0], accuracy[2, :, 1], label="Accuracy SGD - WarmEpochsFactor = 30", color="green")
ax[1].plot(accuracy[3, :, 0], accuracy[3, :, 1], label="Accuracy SGD - WarmEpochsFactor = 40", color="yellow")
ax[1].plot(accuracy[4, :, 0], accuracy[4, :, 1], label="Accuracy SGD - WarmEpochsFactor = 50", color="cyan") 
...
ax[2].plot(test_losses[0, :, 0], test_losses[0, :, 1], label="Test Loss SGD - WarmEpochsFactor = 10", color="blue")
ax[2].plot(test_losses[1, :, 0], test_losses[1, :, 1], label="Test Loss SGD - WarmEpochsFactor = 20", color="red")
ax[2].plot(test_losses[2, :, 0], test_losses[2, :, 1], label="Test Loss SGD - WarmEpochsFactor = 30", color="green")
ax[2].plot(test_losses[3, :, 0], test_losses[3, :, 1], label="Test Loss SGD - WarmEpochsFactor = 40", color="yellow")
ax[2].plot(test_losses[4, :, 0], test_losses[4, :, 1], label="Test Loss SGD - WarmEpochsFactor = 50", color="cyan")
...
plt.tight_layout()
plt.savefig('Comparing_Different_schedulerfactors_ForSGD-0.001_and_mom=0.85.png')
plt.show()
