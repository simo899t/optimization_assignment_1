...
optimizers = []
momentum_val = 0.9
optimizers.append(optim.SGD(models[0].parameters(), lr=0.001, momentum=momentum_val))
optimizers.append(optim.SGD(models[1].parameters(), lr=0.01, momentum=momentum_val))
optimizers.append(optim.SGD(models[2].parameters(), lr=0.02, momentum=momentum_val))
optimizers.append(optim.SGD(models[3].parameters(), lr=0.025, momentum=momentum_val))
optimizers.append(optim.SGD(models[4].parameters(), lr=0.03, momentum=momentum_val))


modelSTD = LeNet5().to(device)
optimizerSTD = optim.SGD(modelSTD.parameters(), lr=0.001, momentum=0.85)
...
# Plot Train Loss
ax[0].plot(train_losses[0, :, 0], train_losses[0, :, 1], label="Train Loss SGD - lr=0.001", color="blue")
ax[0].plot(train_losses[1, :, 0], train_losses[1, :, 1], label="Train Loss SGD - lr=0.01", color="red")
ax[0].plot(train_losses[2, :, 0], train_losses[2, :, 1], label="Train Loss SGD - lr=0.02", color="green")
ax[0].plot(train_losses[3, :, 0], train_losses[3, :, 1], label="Train Loss SGD - lr=0.025", color="yellow")
ax[0].plot(train_losses[4, :, 0], train_losses[4, :, 1], label="Train Loss SGD - lr=0.03", color="cyan")
# ax[0].plot(train_losses[5, :, 0], train_losses[5, :, 1], label="Train Loss SGD - No Scheduler", color="lime")
...
# Plot Test Accuracy
ax[1].plot(accuracy[0, :, 0], accuracy[0, :, 1], label="Accuracy SGD - lr=0.001", color="blue")
ax[1].plot(accuracy[1, :, 0], accuracy[1, :, 1], label="Accuracy SGD - lr=0.01", color="red")
ax[1].plot(accuracy[2, :, 0], accuracy[2, :, 1], label="Accuracy SGD - lr=0.02", color="green")
ax[1].plot(accuracy[3, :, 0], accuracy[3, :, 1], label="Accuracy SGD - lr=0.025", color="yellow")
ax[1].plot(accuracy[4, :, 0], accuracy[4, :, 1], label="Accuracy SGD - lr=0.03", color="cyan") 
# ax[1].plot(accuracy[5, :, 0], accuracy[5, :, 1], label="Accuracy SGD - No Scheduler", color="lime") 
ax[1].set_ylabel("Test Accuracy")
ax[1].legend(loc="lower right")
ax[1].grid(True)

# Plot Test Loss
ax[2].plot(test_losses[0, :, 0], test_losses[0, :, 1], label="Test Loss SGD - lr=0.001", color="blue")
ax[2].plot(test_losses[1, :, 0], test_losses[1, :, 1], label="Test Loss SGD - lr=0.01", color="red")
ax[2].plot(test_losses[2, :, 0], test_losses[2, :, 1], label="Test Loss SGD - lr=0.02", color="green")
ax[2].plot(test_losses[3, :, 0], test_losses[3, :, 1], label="Test Loss SGD - lr=0.025", color="yellow")
ax[2].plot(test_losses[4, :, 0], test_losses[4, :, 1], label="Test Loss SGD - lr=0.03", color="cyan")
# ax[2].plot(test_losses[5, :, 0], test_losses[5, :, 1], label="Test Loss SGD - No Scheduler", color="lime")
...
plt.tight_layout()
plt.savefig('Comparing_Different_lr_for_SGD_mom=0.9.png')
plt.show()
